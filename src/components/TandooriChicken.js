...
export const TandooriChicken = () => {
  ...
  return (
    <React.Fragment>
      ...
      <h1 className="text-center text-success my-5" style={{ position: "relative", left: "10%", top: "40px", fontWeight: "600", fontSize: "60px", }}>Tandoori Chicken</h1>
      
      <h1 style={{ position: "relative", top: "50px", left: "15%", color: "green", }}>Ingredients<br /></h1>
      ...
      <img src={tandooriChicken} style={{ position: "relative", height: "2", borderRadius: "50%", width: "35%", left: "-25%", top: "490px", }} alt='tandoorichicken.jpg' />

      <h3 className="text-center text-dark my-5" style={{ position: "relative", left: "10%", top: "-190px", fontWeight: "600", }}>Follow these Steps to make your yummy Tandoori Chicken</h3>
