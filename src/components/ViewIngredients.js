...
export const ViewIngredients = () => {
  ...
  return (
    <React.Fragment>
      ...
      <h1 className="text-center text-success my-5" style={{ position: "relative", left: "10%", top: "40px", fontWeight: "600", fontSize: "60px", }}>Good Pancakes</h1>
      ...
      <h3 className="text-center text-dark my-5" style={{ position: "relative", left: "10%", top: "-190px", fontWeight: "600", }}>Follow these Steps to make your yummy pancake</h3>
