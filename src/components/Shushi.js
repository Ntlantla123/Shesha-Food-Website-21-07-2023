...
export const Shushi = () => {
  ...
  return (
    <React.Fragment>
      ...
      <h1 className="text-center text-success my-5" style={{ position: "relative", left: "10%", top: "40px", fontWeight: "600", fontSize: "60px", }}>Shiki Shushi</h1>
        ...
        <img src={shushi} style={{ position: "relative", height: "2",borderRadius:"50%", width: "35%", left: "-25%", top: "490px", }} alt='viewpancake2.png' />

        <h3 className="text-center text-dark my-5" style={{ position:"relative", left:"10%", top:"-190px", fontWeight: "600", }}>Follow these Steps to make your yummy Shiki Shushi</h3>
